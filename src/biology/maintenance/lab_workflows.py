"""Lab computational workflow catalog and normalization helpers."""
...
""",
    ...
    LabWorkflow(
        "labs/unit_IV/lab_epigenetic_inheritance_and_disease.md",
        "src/biology/genetics/genetics.py",
        _body(
...
""",
    ...
    LabWorkflow(
        "labs/unit_V/lab_mendelian_principles.md",
        "src/biology/genetics/genetics.py",
        _body(
...
""",
    ...
    LabWorkflow(
        "labs/unit_VII/lab_antimicrobial_resistance_and_epidemiology.md",
        "src/biology/microbiology/microbiology.py",
        _body(
...
def normalise_lab(workflow: LabWorkflow, *, dry_run: bool = False, write_fn=None) -> bool:
    """Normalize one lab file. Return True when content would change."""
    if write_fn is None:
        from textbook_io import write_text_atomic as write_fn
