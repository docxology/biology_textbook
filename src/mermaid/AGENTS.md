...
Inline manuscript Mermaid is separate: the manuscript currently has 193 inline fences, each requiring one alt comment and one italic caption. PDF preprocessing renders those fences strictly to PNG under `output/figures/mermaid_inline/`.
