...
- **Connections:** See \nameref{sec:unit_II_unit_intro} (membrane transport and aquaporin structure), \nameref{sec:unit_IX_unit_intro} (renal concentration gradients and ADH), and \nameref{sec:unit_VIII_unit_intro} (transpiration and [**xylem**](#gl:xylem) tension).
