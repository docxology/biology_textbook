# Lab 33 — Community Ecology and Species Interactions {.unnumbered}

\label{sec:lab_unit_X_community_ecology}
...
- **Outcome 1 (LO1):** Interpret the supplied evidence or model output for Community Ecology and Species Interactions.
...
4. **Connection back to the textbook** — identify one section of
   \cref{sec:unit_X_community_ecology} that your data either confirmed or
   complicated. Cite the specific passage.

## Further Reading (Lab) {.unnumbered}

- Revisit the parent chapter \cref{sec:unit_X_community_ecology} for the theoretical
...
*Module footer: parent chapter `\cref{sec:unit_X_community_ecology}`; all numerical
