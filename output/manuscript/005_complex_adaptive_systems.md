...
> **Unit 0** · Level 2/3 · 35 min read · 50 min lecture · Prerequisites: \cref{sec:unit_0_systems_science}
...
$$ \frac{P(x_2)}{P(x_1)} = \left(\frac{x_2}{x_1}\right)^{-\alpha}  \label{eq:unit_0_complex_adaptive_systems_item_1}$$


**Substitute the known values** ($x_1 = 10$, $x_2 = 100$, $\alpha = 1.5$):

$$ \frac{P(100)}{P(10)} = \left(\frac{100}{10}\right)^{-1.5}  \label{eq:unit_0_complex_adaptive_systems_item_2}$$


$$ \frac{P(100)}{P(10)} = (10)^{-1.5}  \label{eq:unit_0_complex_adaptive_systems_item_3}$$


$$ (10)^{-1.5} = \frac{1}{\sqrt{10^3}} = \frac{1}{\sqrt{1000}} \approx \frac{1}{31.62} \approx 0.0316  \label{eq:unit_0_complex_adaptive_systems_item_4}$$


**Calculate the final probability.**

$$ P(100) = P(10) \times 0.0316 = 0.05 \times 0.0316 \approx 0.00158  \label{eq:unit_0_complex_adaptive_systems_item_5}$$
