...
This unit bridges the gap between the molecular genetics of Unit IV and the evolutionary dynamics of
Unit VI. You will derive Mendelian ratios from first principles, work through the mathematics of
...
graph TD
    ...
    POP["👥 Population Genetics<br/>(Hardy-Weinberg:<br/>p² + 2pq + q² = 1)"] --> DRIFT["🌊 Genetic Drift<br/>(Unit VI →)"]
...
**Unit V concept map — Classical Genetics and Heredity.**
...
- **Meiosis and crossing-over** (\cref{sec:unit_V_chromosomal_inheritance}) build directly on DNA replication and chromosome structure from Unit IV, and provide the mechanistic basis for recombination in Unit VI (evolution).
...
- **Pedigree analysis** and **inheritance patterns** reappear throughout Unit IX (genetic basis of cardiovascular disease, endocrine disorders, immune deficiencies).
- **Epistasis and polygenic traits** link to Unit VI (quantitative trait loci, QTL mapping) and Unit X (population-level phenotypic variation in ecology).
