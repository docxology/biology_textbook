...
> 
> For decades, textbooks cited the figure that the human body contains ten times more bacterial cells than human cells. In 2016, Ron Milo and Ron Sender published a careful recalculation in *Cell* — the ratio is approximately 1:1, with roughly 38 trillion bacteria and 30 trillion human cells. But the bacteria contribute only about 0.2 kg of body mass, compared to 70 kg of self. What changed science wasn't the ratio but the Human Microbiome Project (2007–2016), which used 16S rRNA sequencing to catalogue ~10,000 microbial species across 18 body sites in 300 healthy adults. The project revealed that gut microbiome composition influences immunity, metabolism, neurotransmitter production, and drug efficacy — and differs between individuals as distinctly as a fingerprint. The microbiome is now recognised as an additional organ, and its disruption (dysbiosis) is linked to inflammatory bowel disease, obesity, depression, and antibiotic-associated colitis. We are ecosystems, not individuals.

## Microbial Ecology Approaches

### The Great Plate Count Anomaly

In 1985, Staley and Konopka formalized a long-recognized paradox in microbiology: when environmental samples are examined by direct microscopic counts or flow cytometry, cell densities of $10^6$ per milliliter are typical in aquatic environments. Yet when the same samples are plated on standard laboratory media, primarily $10^2$-$10^3$ colony-forming units (CFU) per milliliter grow -- less than 1% of the organisms present. This discrepancy, termed the **great plate count anomaly**, revealed that the vast majority of microbial diversity is invisible to traditional culture-based microbiology.
...
- **Shotgun metagenomics** sequences most DNA in a sample without amplification: no PCR bias; captures most organisms including viruses and eukaryotic microbes; enables functional gene profiling; produces **metagenome-assembled genomes (MAGs)** — reconstructed genomes of uncultured organisms from metagenomic reads using coverage depth and tetranucleotide frequency binning. The Human Microbiome Project (HMP, 2008-2014) characterized the microbiomes of 300 healthy adults across 18 body sites, generating > 5.2 Tbp of sequence data.
...
The human body harbors approximately $3.8 \times 10^{13}$ bacterial cells -- close to the number of human somatic cells ($3.7 \times 10^{13}$). The microbial gene catalog is far larger: approximately 3.3 million unique microbial genes compared to approximately 20,000 human [**protein**](#gl:protein)-coding genes, a ratio exceeding 150:1. This "second genome" provides metabolic capabilities that human cells lack, effectively extending our biochemical repertoire.
...
The landmark study by Turnbaugh et al. (2006, *Nature*) demonstrated that the gut microbiome of obese mice (ob/ob) has an increased Firmicutes/Bacteroidetes (F/B) ratio compared to lean littermates. When the obese microbiome was transplanted into germ-free mice, recipients gained 60% more body fat than recipients of lean microbiome -- despite consuming identical diets. The mechanism involves increased energy harvest from dietary polysaccharides (the obese microbiome has enhanced capacity to ferment complex carbohydrates) and altered SCFA profiles affecting host energy regulation.
...
16. **Kill-the-winner test.** Design a 30-day metagenomic time-series experiment in a marine mesocosm to test whether *Prochlorococcus* abundance and cyanophage abundance show predator-prey oscillations. Specify sampling frequency, sequencing approach, and the statistical analysis (cross-correlation, lagged regression) you would use.## Further Reading and Source Notes
...
- Turnbaugh, Ley, Hamady, Fraser-Liggett, Knight & Gordon (2007). The human microbiome project. *Nature*, 449.
- Falkowski, Fenchel & Delong (2008). The microbial engines that drive Earth's biogeochemical cycles. *Science*, 320.
- Sender, Fuchs & Milo (2016). Revised estimates for the number of human and bacteria cells in the body. *PLOS Biology*, 14.
