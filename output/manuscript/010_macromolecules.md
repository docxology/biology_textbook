...
**Phosphorylation** is the most-studied PTM: ~30% of human proteins are phosphorylated on at least one residue at some point in their life cycle, controlled by 518 kinases and ~150 phosphatases. A single phosphate group adds two negative charges and ~30 kJ/mol of binding energy with phospho-recognition domains (SH2, 14-3-3, FHA), enabling switch-like regulation of activity, localisation, or partnerships. **Histone PTMs** (acetylation of Lys, methylation of Lys/Arg, phosphorylation of Ser/Thr) write the "histone code" that organises chromatin into transcriptionally active and silent states (see Unit IV).
