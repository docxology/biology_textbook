...
- **Connections:** See \cref{sec:unit_V_population_genetics} for formal $p$ recursions, \cref{sec:unit_VI_genetic_drift_and_speciation} for drift vs. selection, and Unit X for spatial sorting and range expansion.
