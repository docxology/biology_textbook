...
### Field Translation: Fertility, Phenology, and Containment

Plant reproductive claims are especially sensitive to the step being measured. Heat can reduce seed set by damaging tapetum development, microspores, pollen viability, pollen-tube growth, or ovule/endosperm development, and these stages differ in timing and temperature threshold \citep{malik2022heatstressmale}. Phenology claims need the cue model: spring ephemeral flowering in *Corydalis ambigua* tracked snowmelt and surface degree-days, while bumblebee emergence tracked soil warming; seed set declined when flowers opened before bee emergence in a 19-year field series and snow-removal experiment \citep{kudo2019phenologicalmismatch}.

The same logic applies to gene drives and engineered reproductive systems. A plant gene drive or apomictic trait is not just a molecular construct; it is a population process shaped by dispersal, seed dormancy, mating system, hybrid fitness, and governance. Responsible evaluation uses staged containment, ecological risk assessment, community engagement, and explicit reversibility or mitigation planning before open release \citep{nasem2016genedrives}.
...
- **Connections:** See Unit IV for meiosis and life cycle, \cref{sec:unit_VIII_plant_structure_and_water} for water and growth, and \cref{sec:unit_III_photosynthesis} for photosynthate partitioning.
