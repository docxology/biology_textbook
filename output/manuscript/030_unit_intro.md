...
```
<!-- alt: Graph showing unit VI concept map — Evolution. Red = selection; blue = drift; green = phylogenetics; orange = molecular clock. -->

*Unit VI concept map — Evolution. Red = selection; blue = drift; green = phylogenetics; orange = molecular clock.*
...
- **Molecular clock** and **Jukes-Cantor distances** connect to Unit IV (mutation rates in DNA replication) and Unit VII (phylogeny of pathogens and antibiotic-resistance evolution).
- **Speciation** links to Unit X (biogeography, island species-area relationship, MacArthur-Wilson model).
- **Adaptive evolution** of immune genes connects to Unit IX (MHC diversity and pathogen immunity), and antibiotic resistance evolution motivates the clinical sections of Unit VII.
