...
- **Connections:** See \cref{sec:unit_III_photosynthesis} for photosynthetic GPP/NPP concepts, Unit VIII for transpiration in the water cycle, and \cref{sec:unit_X_biomes_and_conservation} for biome NPP benchmarks.
