...
graph TD
    ...
    STRUC --> PHOTO["☀️ Photosynthesis<br/>(Unit III →<br/>C₃, C₄, CAM pathways)"]
...
```
<!-- alt: Flowchart for Key Concepts and Connections: 🌿 Plant Structure (roots, stems, leaves; meristems; vascular: xylem/phloem), 💧 Water Relations (Ψ = Ψs + Ψp; cohesion-tension mechanism), 🌬️ Transpiration (stomata; guard cells; transpiration stream), and ☀️ Photosynthesis (Unit III → C₃, C₄, CAM pathways) form the diagram's primary path or branches. -->

*Flowchart for Key Concepts and Connections: 🌿 Plant Structure (roots, stems, leaves; meristems; vascular: xylem/phloem), 💧 Water Relations (Ψ = Ψs + Ψp; cohesion-tension mechanism), 🌬️ Transpiration (stomata; guard cells; transpiration stream), and ☀️ Photosynthesis (Unit III → C₃, C₄, CAM pathways) form the diagram's primary path or branches.*

**Unit VIII concept map — Plant Biology.**
...
- **Plant hormone receptor signalling** (auxin, ABA) uses the same signalling classes covered in Unit II (cell signalling: receptor kinases, second messengers).
- **Plant-pollinator and plant-mycorrhizal interactions** connect to Unit X (community ecology, mutualism, co-evolution).
- **Secondary metabolites as medicines** (alkaloids, terpenoids) link to Unit I (functional groups) and Unit VII (antimicrobial compounds).
