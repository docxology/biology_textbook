...
### Structural Variation, Consent, and Chromosome-Scale Counseling

Chromosome-scale inheritance is clinically useful because it links a visible or sequenced rearrangement to a reproductive risk. It is also easy to overstate. Karyotypes, chromosomal microarrays, short-read sequencing, long-read sequencing, and graph-reference alignment see different classes of variation: balanced translocations, copy-number variants, repeat expansions, inversions, and complex rearrangements can move between visible cytogenetics and sequence-level evidence. The Human Pangenome Reference highlights why a single linear reference can miss or misrepresent variants carried by under-sampled ancestries \citep{humanpangenome2023}.

For prenatal, carrier, or infertility testing, the counseling note should name the assay and its blind spots, distinguish screening from diagnosis, state whether a variant is pathogenic or uncertain, and explain family implications without treating relatives as automatic research subjects. Consent and data-retention language matter because chromosomal findings can expose non-paternity, consanguinity, incidental adult-onset risks, or information relevant to relatives who did not choose testing.
