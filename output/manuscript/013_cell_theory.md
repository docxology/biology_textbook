...
- **Connections:** See \cref{sec:unit_II_cell_structure} for organelle inventory, Unit VII for prokaryotic diversity, and Unit VI for common ancestry and LUCA reasoning.
