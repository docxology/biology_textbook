...
### Field Translation: Hydraulic Safety Margins

Water-potential models move from classroom equations to field prediction when they name the operating range. A hydraulic safety margin compares the water potential a plant actually reaches during drought with the water potential that causes damaging loss of xylem conductivity. Choat and colleagues found that 70% of 226 sampled forest species from 81 sites operated with margins narrower than 1 MPa against injurious hydraulic stress \citep{choat2012hydraulicmargins}. That result is a warning signal, not a one-number forecast: mortality risk also depends on rooting depth, stored water, non-structural carbohydrate reserves, stomatal regulation, recovery after embolism, heat load, pests, and repeated drought history.

When evaluating a drought-tolerant crop or forest-management claim, ask for the species, tissue, growth stage, vapor-pressure deficit, soil depth, measured $\Psi_{\mathrm{min}}$, embolism threshold, and yield or survival endpoint. A greenhouse water-potential treatment can demonstrate mechanism, but field adoption requires replicated seasons and soils because stomatal closure that protects xylem can reduce carbon gain and reproduction.
