...
- **Connections:** See \cref{sec:unit_IV_dna_replication_and_cell_cycle} for repair pathways, Unit V for inheritance of variants, and Unit VII for CRISPR origins in bacterial immunity.
