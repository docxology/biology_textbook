...
- **Connections:** See \cref{sec:unit_IV_epigenetics_and_gene_regulation} for chromatin and RNAi, Unit VI for how expression variation fuels evolution, and \cref{sec:unit_II_cell_signaling} for signal-driven transcription factors.
