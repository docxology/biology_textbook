...
- **Connections:** See \cref{sec:unit_III_photosynthesis} for light-driven phosphorylation, \cref{sec:unit_III_metabolic_integration} for hormonal integration, and Unit X for ecosystem productivity and reduced carbon.
