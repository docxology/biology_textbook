...
- **Connections:** See \cref{sec:unit_X_community_ecology} for species interactions, \cref{sec:unit_V_population_genetics} for [**allele**](#gl:allele) frequencies in subdivided populations, and Unit VI for life-history evolution.
